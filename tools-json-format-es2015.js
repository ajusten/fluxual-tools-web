...
class JsonFormatComponent extends src_app_core_transform_tool_transform_tool_component__WEBPACK_IMPORTED_MODULE_1__["TransformToolComponent"] {
    constructor() {
        super(...arguments);
        this.id = 'json-format';
        this.action = 'Format';
