...
const routes = [
    ...
    {
        path: 'json',
        loadChildren: () => __webpack_require__.e(/*! import() | json-json-module */ "json-json-module").then(__webpack_require__.bind(null, /*! ./json/json.module */ "./src/app/json/json.module.ts")).then(m => m.JsonModule)
    },
    {
        path: 'xml',
        loadChildren: () => __webpack_require__.e(/*! import() | xml-xml-module */ "xml-xml-module").then(__webpack_require__.bind(null, /*! ./xml/xml.module */ "./src/app/xml/xml.module.ts")).then(m => m.XmlModule)
    }
];
