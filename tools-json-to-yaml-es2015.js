...
class JsonToYamlComponent extends src_app_core_transform_tool_transform_tool_component__WEBPACK_IMPORTED_MODULE_1__["TransformToolComponent"] {
    constructor() {
        super(...arguments);
        this.id = 'json-to-yaml';
        this.action = 'Convert';
        this.schema = {
            type: 'object',
            properties: {
    ...
    onTransform(transform) {
        const result = yaml__WEBPACK_IMPORTED_MODULE_2___default.a.parse(transform.input);
        return yaml__WEBPACK_IMPORTED_MODULE_2___default.a.stringify(result);
    }
}
let JsonToYamlModule = class JsonToYamlModule {
};
