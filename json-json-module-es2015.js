...
const routes = [
    {
        path: 'format',
        loadChildren: () => __webpack_require__.e(/*! import() | json-format-json-format-module */ "json-format-json-format-module").then(__webpack_require__.bind(null, /*! ./json-format/json-format.module */ "./src/app/json/json-format/json-format.module.ts")).then(m => m.JsonFormatModule)
    }
];
let JsonRoutingModule = class JsonRoutingModule {
};
